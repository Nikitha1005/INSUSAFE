...
class _ReminderPageState extends State<ReminderPage> {
  ...
  void _loadReminders() {
    final emailKey = widget.patientEmail.replaceAll('.', ','); // Firebase key fix
  ...
  void _showAddReminderSheet() {
    showModalBottomSheet(
      ...
      builder: (_) => AddReminderForm(patientEmail: widget.patientEmail),
    );
  }
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text("Add ${_nextDosageLabel ?? 'Dosage'}",
            ...
            ElevatedButton.icon(
              ...
              style:
              ElevatedButton.styleFrom(minimumSize: const Size(double.infinity, 45)),
            ),
